...
var (
	pkg       = flag.String("assert-path", "github.com/jannisbaudisch/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/jannisbaudisch/testify/_codegen
